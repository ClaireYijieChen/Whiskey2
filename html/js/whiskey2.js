  ...
  Whiskey2 = (function() {
    ...
    Whiskey2.prototype.refreshNotepads = function(selectID) {
      ...
      return this.manager.storage.select('notepads', [
        ...
        var a, div, i, item, li, moveNotepad, _fn, _i, _ref, _results;
        if (err) {
  ...
  Notepad = (function() {
    ...
    Notepad.prototype.loadNotes = function(sheet, parent, canvas, zoom) {
      ...
      loadNote = function(note) {
        var div, fi, files, i, line, lines, notewidth, renderIcon, resizer, width, x, y, _i, _j, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
    ...
    Notepad.prototype.loadSheet = function(index, div) {
      ...
      divContent.bind('mousedown', function(e) {
        var coords, notes, offset, x, y, _ref1, _ref2;
        offset = _this.app.dragGetOffset(e, divContent);
        _ref1 = offsetToCoordinates(offset.left, offset.top), x = _ref1[0], y = _ref1[1];
        _ref2 = notesInRectangle(x, y, x, y), coords = _ref2[0], notes = _ref2[1];
      ...
      divContent.bind('mouseup', function(e) {
        var coords, note, notes, offset, x, y, _i, _len, _ref1, _ref2;
        ...
        if (_this.selectorDiv && _this.selectorIndex === index) {
          offset = _this.app.dragGetOffset(e, divContent);
          _ref1 = offsetToCoordinates(offset.left, offset.top), x = _ref1[0], y = _ref1[1];
          _ref2 = notesInRectangle(x, y, _this.selectorX, _this.selectorY), coords = _ref2[0], notes = _ref2[1];
          for (_i = 0, _len = notes.length; _i < _len; _i++) {
            note = notes[_i];
            if (_this.selectedNotes[note.id]) {
              delete _this.selectedNotes[note.id];
      ...
      divContent.bind('dblclick', function(e) {
        var x, y, _ref1, _ref2;
        _ref1 = offsetToCoordinates(e.offsetX, e.offsetY), x = _ref1[0], y = _ref1[1];
        _ref2 = stickToGrid(x, y), x = _ref2[0], y = _ref2[1];
      ...
      divContent.bind('drop', function(e) {
        var bmark, config, id, offset, otherNote, resizer, x, y, _i, _len, _ref1, _ref2, _ref3, _ref4;
        bmark = _this.app.dragGetType(e, 'custom/bmark');
        if (bmark) {
          _this.moveBookmark(bmark.id, sheet);
          e.stopPropagation();
        ...
        if (resizer) {
          ...
          _this.app.manager.findOne('notes', resizer.id, function(err, note) {
            var newWidth, w, _i, _len, _ref2;
            if (err) {
              return _this.app.showError(err);
            }
            width = Math.max(_this.noteWidths[0], x - note.x);
            newWidth = width;
            _ref2 = _this.noteWidths;
        ...
        if (_this.app.dragHasType(e, 'custom/note')) {
          ...
          if (otherNote.id) {
            ...
            _this.app.manager.batch(config, function(err, arr) {
              var moveX, moveY, note, updates, _j, _ref5;
              if (err) {
                return _this.app.showError(err);
              }
              updates = [];
              ...
              for (index = _j = 0, _ref5 = arr.length; 0 <= _ref5 ? _j < _ref5 : _j > _ref5; index = 0 <= _ref5 ? ++_j : --_j) {
                note = arr[index];
                if (index === 0) {
                  moveX = note.x - x;
                  moveY = note.y - y;
