...
(function() {
  ...
  Whiskey2 = (function() {
    ...
    Whiskey2.prototype.dragGetType = function(e, type) {
      ...
      if (e != null ? (_ref = e.originalEvent) != null ? (_ref1 = _ref.dataTransfer) != null ? _ref1.getData : void 0 : void 0 : void 0) {
        try {
          return JSON.parse(e != null ? (_ref2 = e.originalEvent) != null ? (_ref3 = _ref2.dataTransfer) != null ? _ref3.getData(type) : void 0 : void 0 : void 0);
        } catch (e) {
          return null;
        }
      }
  ...
  Notepad = (function() {
    ...
    Notepad.prototype.showSheetDialog = function(sheet, handler) {
      var templateButtonText, templateID, ul, _ref, _ref1,
        _this = this;
    ...
    Notepad.prototype.initSheetPlaceholders = function() {
      var div, divContent, divTitle, divToolbar, i, _i, _ref, _results;
      this.sheetDivs = [];
      _results = [];
    ...
    Notepad.prototype.showNotesDialog = function(sheet, note, handler) {
      var a, adiv, color, colors, currentColor, currentWidth, width, widths, _i, _j, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6,
        _this = this;
    ...
    Notepad.prototype.loadNotes = function(sheet, parent) {
      ...
      loadNote = function(note) {
        var div, i, line, lines, width, x, y, _i, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _results;
        ...
        width = (_ref1 = note.width) != null ? _ref1 : _this.noteWidths[_this.noteDefaultWidth];
        ...
        lines = ((_ref4 = note.text) != null ? _ref4 : '').split('\n');
        _results = [];
    ...
    Notepad.prototype.loadSheet = function(index, div) {
      ...
      divContent.bind('drop', function(e) {
        var bmark, config, id, offset, otherNote, x, y, _i, _len, _ref1, _ref2, _ref3;
        bmark = _this.app.dragGetType(e, 'custom/bmark');
        if (bmark) {
          _this.moveBookmark(bmark.id, sheet);
          e.stopPropagation();
        ...
        if (_this.app.dragHasType(e, 'custom/note')) {
          ...
          offset = _this.app.dragGetOffset(e, divContent);
          _ref1 = offsetToCoordinates(offset.left - otherNote.x, offset.top - otherNote.y), x = _ref1[0], y = _ref1[1];
          _ref2 = stickToGrid(x, y), x = _ref2[0], y = _ref2[1];
          if (otherNote.id) {
