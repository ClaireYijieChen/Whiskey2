...
(function() {
  ...
  Whiskey2 = (function() {
    ...
    Whiskey2.prototype.findByID = function(arr, id, start) {
      ...
      for (i = _i = start, _ref = arr.length; start <= _ref ? _i < _ref : _i > _ref; i = start <= _ref ? ++_i : --_i) {
        if (arr[i].id === id) {
          return i;
        }
      }
  ...
  Notepad = (function() {
    ...
    Notepad.prototype.renderSheetMiniatures = function(sheets) {
      var div, divItem, divItemText, h, height, i, maxHeight, minHeight, oneItemHeight, sheet, step, _fn, _i, _ref,
        _this = this;
    ...
    Notepad.prototype.showNotesDialog = function(sheet, note, handler) {
      var a, adiv, color, colors, width, widths, _i, _j, _len, _ref, _ref1, _ref2, _ref3, _ref4,
        _this = this;
      ...
      for (color = _i = 0, _ref1 = this.colors; 0 <= _ref1 ? _i < _ref1 : _i > _ref1; color = 0 <= _ref1 ? ++_i : --_i) {
        a = $(document.createElement('a')).addClass('btn').attr({
          href: '#'
        }).data('index', color);
        a.appendTo(colors);
        if (((_ref2 = note.color) != null ? _ref2 : 0) === color) {
          a.addClass('active');
        }
        adiv = $(document.createElement('div')).addClass('note-color-button note-color' + color).html('&nbsp;').appendTo(a);
      }
      colors.button();
      _ref3 = this.noteWidths;
      for (_j = 0, _len = _ref3.length; _j < _len; _j++) {
        ...
        if (((_ref4 = note.width) != null ? _ref4 : this.noteWidths[0]) === width) {
          a.addClass('active');
        }
      }
      widths.button();
    ...
    Notepad.prototype.loadNotes = function(sheet, parent) {
      ...
      loadNote = function(note) {
        ...
        width = (_ref1 = note.width) != null ? _ref1 : _this.noteWidths[0];
        width = preciseEm(width);
        x = preciseEm((_ref2 = note.x) != null ? _ref2 : 0);
        y = preciseEm((_ref3 = note.y) != null ? _ref3 : 0);
        div.css({
          width: "" + width + "em",
          left: "" + x + "em",
          top: "" + y + "em"
